...
class Fellowship extends Common {
	...
	*/
	 ...
	 */
     ...
     public function index() {
		...
		//assign public class values to function variable
			...
			$template['body_content'] = $this->load->view('frontend/pages/fellowship/index', $data, true);	
		    $this->load->view('frontend/layouts/template', $template, false);			
	}
	...
	public function index2() {
		...
		//assign public class values to function variable
			...
			$data['common_data']['page'] = 'courses';
				$data['listing']=$this->page_model->getFellowshipListing();
			$template['body_content'] = $this->load->view('frontend/pages/fellowship/index1', $data, true);	
		    $this->load->view('frontend/layouts/template', $template, false);			
	}
