	...
	*/
	...
	public function index() {
		$data['common_data'] = $this->common_data;
			$template['body_content'] = $this->load->view('frontend/reviews/index', $data, true);	
		$this->load->view('frontend/layouts/template', $template, false);	
	}

		public function details() {
		$data['common_data'] = $this->common_data;
			$template['body_content'] = $this->load->view('frontend/reviews/view-reviews-content', $data, true);	
		$this->load->view('frontend/layouts/template', $template, false);	
	}
