...
function userStatusEmail($status,$username,$to_email,$reason){
	//Getting email details from DB
	$from_email = NO_REPLY;
	$email_type = "yes";
...
function talentBookingEmail($job_id,$username,$to_email){
	//Getting email details from DB
	$from_email = NO_REPLY;
	$email_subject = "Job Created by Employer - Wowzer";
	$url = BACKEND_EDIT_JOB_URL."?job_id=".$job_id;
	$email_content = "Hello Admin,<br /><br /> Employer ".ucwords($username)." has created a new job, Kindly review at this link: <a href='".$url."'>Link</a>.<br /><br />Regards,<br/>Support Team";
