...
/*    if (!isset($response_params['access_token'])) {
    ...
    if (!isset(json_decode($access_token_response)->access_token)) {
      return false;
    }

    return json_decode($access_token_response)->access_token;
  }
    ...
    switch ($e->getType()) {
      ...
      case 'Exception':
        ...
        if ((strpos($message, 'Error validating access token') !== false) ||
            ...
            (strpos($message, 'An active accfacebookess token must be used') !== false)
        ) {
          $this->destroySession();
        }
        break;
