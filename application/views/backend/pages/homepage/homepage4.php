<div class="page-fixed-main-content" style="min-height: 380px">
	...
	<div class="col-md-12 col-xs-12 col-sm-12 performance-form">
		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" id="addAboutForm" name="addAboutForm" onsubmit="updateMidLeftContent('4'); return false;" >
				<div class="form-body">
					<!--/row-->
					<div class="row">
						<?php foreach ($homepage_Left_Mid_content as $key => $value) { ?>
