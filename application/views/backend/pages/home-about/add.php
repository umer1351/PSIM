			...
			<form class="horizontal-form student-details-form custom-details-form" id="addAboutForm" name="addAboutForm" onsubmit="editAboutSection(<?php echo $page_data['id']?>); return false;" >
				<div class="form-body">
					...
					<div class="row">
						...
						<div class="col-md-8" <?php echo ($page_data['image_url'] != "none")? "":"style='display:none'" ?>>
						...
						<input type="hidden" value="<?php echo HOMEPAGE ?>" data-url="<?php echo BACKEND_EDIT_ABOUT_SECTIONS ?>" id="home_about_id">
						<br />						
						<div class="col-md-12">
							<div class="form-group">
