<div class="page-fixed-main-content" style="min-height: 380px">
	...
	<div class="col-md-12 col-xs-12 col-sm-12 performance-form">
		<div class="page-heading-related">
			<h3 class="form-section float-left-style"><?php echo ($slide ? 'Edit':'Add'); ?> Exams</h3>

			<div class="actions product-det-heading-n-btn">
				<?php if($slide){ ?>
				<a href="<?php echo BACKEND_EXAMS_DETAILS_ADD."?slide=".$slide['id'] ?>">Add Details </a> <span> </span>
				<a href="<?php echo BACKEND_EXAMS_MEDIA_ADD."?slide=".$slide['id'] ?>"> Media Gallery</a>
			<?php } ?>
			<?php
		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" onsubmit="addExamsListing(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:'0');?>); return false;" id="addHomepageSlideForm" name="addHomepageSlideForm" >
							...
							<div class="form-group cateogory-banner-custom">
								...
								<!-- <span class="img_name"></span> -->
								  ...
								  <div id='add_product_image' class="category_banner_image">
									<img src="<?php echo (isset($slide['image']) && !empty($slide['image']))? ASSET_UPLOADS_FRONTEND_DIR."exams/".$slide['image']:ASSET_IMAGES_BACKEND_DIR.'dummy-img.png'; ?>" id='image_id' class="image" alt="Home Slider Image" data-tag="<?php echo (isset($slide['image']) && !empty($slide['image']))? $slide['image']:0; ?>">
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="addExamsListing(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
					...
					<table id="stream_table" class="table table-striped table-bordered table-hover table-students">
						...
						?>
								<tr id="user">
									...
									<td ><?php echo date('d-m-Y', $module['time']); ?></td>
