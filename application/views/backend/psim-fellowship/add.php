<div class="page-fixed-main-content" style="min-height: 380px">
	...
	<div class="col-md-12 col-xs-12 col-sm-12 performance-form">
		<div class="page-heading-related">
			<h3 class="form-section float-left-style"><?php echo ($slide ? 'Edit':'Add'); ?> Conference</h3>
			<div class="actions product-det-heading-n-btn">
				<?php if($slide){ ?>
				<a href="<?php echo BACKEND_FELLOWSHIPS_DETAILS_ADD."?slide=".$slide['id'] ?>">Add Details</a>
				<a href="<?php echo BACKEND_FELLOWSHIPS_MEDIA_ADD."?slide=".$slide['id'] ?>">Add Media</a>
			<?php } ?>
			<?php
		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" onsubmit="addExamsListing(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:'0');?>); return false;" id="addHomepageSlideForm" name="addHomepageSlideForm" >
						...
						<div class="col-md-4">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="date" class="form-control" id="course_start_date" placeholder="Registration date" value="<?php echo ((isset($slide['course_start_date']) && !empty($slide['course_start_date'])) ? date('Y-m-d', $slide['course_start_date']):'');?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label c-label">Decision flag?</label>
									<div class="form-check">
									  <input class="form-check-input radio-type" type="radio" name="exampleRadios2" id="exampleRadios6" value="1" >
									
									    Enable
									  
									  <input class="form-check-input radio-type" type="radio" name="exampleRadios2" id="exampleRadios5" value="0" checked >
									    Disable
							...
							<div class="form-group cateogory-banner-custom">
								...
								<!-- <span class="img_name"></span> -->
								  ...
								  <div id='add_product_image' class="category_banner_image">
									<img src="<?php echo (isset($slide['image']) && !empty($slide['image']))? ASSET_UPLOADS_FRONTEND_DIR."fellowship/".$slide['image']:ASSET_IMAGES_BACKEND_DIR.'dummy-img.png'; ?>" id='image_id' class="image" alt="Home Slider Image" data-tag="<?php echo (isset($slide['image']) && !empty($slide['image']))? $slide['image']:0; ?>">
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="addFellowshipAjax(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
					...
					<table id="stream_table" class="table table-striped table-bordered table-hover table-students">
						...
						?>
								<tr id="user">
									...
									<td>
									<a href="<?php echo BACKEND_FELLOWSHIPS_DETAILS_EDIT."?module=".$module['id'] ?>" class="btn btn-sm btn-circle btn-default"><i class="fa fa-eye"></i> Edit Details</a>
									</td>
								</tr>
