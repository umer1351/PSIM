<div class="page-fixed-main-content" style="min-height: 380px">
	...
	<div class="col-md-12 col-xs-12 col-sm-12 performance-form">
		<div class="page-heading-related">
			<h3 class="form-section float-left-style"><?php echo ($slide ? 'Edit':'Add'); ?> Fellowship Details</h3>
		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" onsubmit="addExamsDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:'0');?>); return false;" id="addHomepageSlideForm" name="addHomepageSlideForm" >
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="col-md-12" style="display:none;">
								<div class="form-group">
									<label class="control-label c-label">Topic</label>
									<input type="text" class="form-control" id="topic" placeholder="Topic" value="<?php echo ((isset($slide['topic']) && !empty($slide['topic'])) ? $slide['topic']:'');?>">
								</div>
							</div>
							<div class="col-md-12" style="display:none;">
								<div class="form-group">
									<label class="control-label c-label">Time</label>
									<input type="time" class="form-control" id="Time" placeholder="Registration date" value="<?php echo ((isset($slide['time']) && !empty($slide['time'])) ? date('H:i', $slide['time']):'');?>">
							...
							<div class="col-md-12" style="display:none;">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="Speaker" placeholder="Speaker" value="<?php echo ((isset($slide['speaker']) && !empty($slide['speaker'])) ? $slide['speaker']:'');?>">
								</div>
							</div>
							<div class="col-md-12">
								<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="Details" class="form-control"><?php echo ((isset($slide['details']) && !empty($slide['details'])) ? str_replace('%^', '"', $slide['details']):'');?></textarea>
								</div>
							</div>
							</div>
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="EditFellowshipDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
