		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" onsubmit="addExamsDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:'0');?>); return false;" id="addHomepageSlideForm" name="addHomepageSlideForm" >
						...
						<div class="col-md-4">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="DetailsAcademic" class="form-control"></textarea>
								</div>
							</div>
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="addAcademicsDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
