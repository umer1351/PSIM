		...
		<!-- BEGIN FORM-->
			<form class="horizontal-form student-details-form custom-details-form" onsubmit="addExamsDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:'0');?>); return false;" id="addHomepageSlideForm" name="addHomepageSlideForm" >
						...
						<div class="col-md-4">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="topic" placeholder="Topic" value="">
								</div>
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label c-label">Time</label>
									<input type="time" class="form-control" id="Time" placeholder="Registration date" value="">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="Details" placeholder="Details" value="">
								</div>
							</div>
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="addExamsDetails(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
