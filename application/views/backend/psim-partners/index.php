...
<!-- BEGIN PAGE BASE CONTENT -->
		<div class="portlet box red">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-picture-o"></i>PSIM Partners Listing</div>
			</div>
			<div class="portlet-body">
					<div class="add-new-btn-custom">
						<div class="btn-group">
							<a id="sample_editable_1_new" href="<?php echo BACKEND_ADD_PARTNERS_URL;  ?>"  class="btn blue"> <i class="fa fa-plus"></i> Add New </a>
						</div>
					</div>
				<div class="">
					<table id="stream_table" class="table table-striped table-bordered table-hover table-students">
						...
						?>
								<tr>
									...
									<td>
									<a href="<?php echo BACKEND_EDIT_PARTNERS."?slide=".$slide['id'] ?>" class="btn btn-sm btn-circle btn-default"><i class="fa fa-pencil"></i> Edit</a>
