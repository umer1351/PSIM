<div class="page-fixed-main-content" style="min-height: 380px">
	...
	<div class="col-md-12 col-xs-12 col-sm-12 performance-form">
		...
		<!-- BEGIN FORM-->
		<form class="horizontal-form student-details-form custom-details-form"  id="addHomepageSlideForm" name="addHomepageSlideForm" >
				<div class="form-body">
					<!--/row-->
					<div class="row">
						<div class="col-md-4">
							...
							<div class="form-group cateogory-banner-custom">
								...
								<!-- <span class="img_name"></span> -->
								  ...
								  <div id='add_product_image' class="category_banner_image">
									<img src="<?php echo (isset($slide['image']) && !empty($slide['image']))? ASSET_UPLOADS_FRONTEND_DIR."partners/".$slide['image']:ASSET_IMAGES_BACKEND_DIR.'dummy-img.png'; ?>" id='image_id' class="image" alt="Home Slider Image" data-tag="<?php echo (isset($slide['image']) && !empty($slide['image']))? $slide['image']:0; ?>">
				...
				<div class="form-actions right">
					<button type="submit" class="btn blue" onClick="addPartnersAjax(<?php echo ((isset($slide['id']) && !empty($slide['id'])) ? $slide["id"]:0);?>); return false;"> <i class="fa fa-check"></i> Save</button>
