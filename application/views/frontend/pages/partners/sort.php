            ...
            <div class="col-md-12">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>psim-partners">All</a> 
                    <a class="dropdown-item" href="<?php echo base_url(); ?>partner-sort?type=Upcoming">Upcoming Courses</a>                   
                    <a class="dropdown-item" href="<?php echo base_url(); ?>partner-sort?type=Completed">Completed Courses</a>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>partner-sort?type=Deferred">Deferred Courses</a>
                  </div>
                </div>
            </div>
        </div>
