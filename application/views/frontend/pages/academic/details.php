...
<div class="mainContentDiv">
	<div class="container">
		<div id="promo-banner-or-social-proof">
		    <a class="btn btn-secondary mt-4" href="<?php echo base_url(); ?>academic-initiatives">Back To Listing</a>
    ...
    background-color: #162542 !important;">
						...
						<div class="card-body">
							...
							<div class="alert alert-info text-primary text-center">
								<?php print_r($listing['details']); ?>
							</div>
							<div class="table-responsive">
								<!-- <?php echo $listing_det['details']; ?> -->
...
<div class="mainContentDiv11">
   ...
   <div class="gallery_container">
	   ...
	   <a class="lightbox text-center" href="<?php echo displayImage(ASSET_UPLOADS_FRONTEND_DIR.'exams/'.$row['file_name']); ?>">
	   <img class="img-fluid" src="<?php echo displayImage(ASSET_UPLOADS_FRONTEND_DIR.'exams/'.$row['file_name']); ?>" alt="Bridge">
	   </a>
	</div>
...
if(!empty($files)){ foreach($files as $row){  
	...
	if($row['type'] == '2'){ ?>
    	 ...
    	 <div class="col-sm-3">
         <div><a href="<?php echo $row['file_name'] ?>" class="video_model"><img src="http://pluspng.com/img-png/play-button-png-projects-330.png"></a></div>
      </div>
    <?php } ?> 
