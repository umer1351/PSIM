    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center mb-50">
                <a href="<?php echo base_url(); ?>examination-courses" class="main-btn filled-btn borderRadiusLeft35">
                    All
                </a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="blog-post-item blog-post-item-five mb-50 wow fadeInUp" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="post-thumbnail">
                        <img src="<?php echo ASSET_UPLOADS_FRONTEND_DIR."exams/examination.png" ?>" alt="Blog Thumb" >
                        <a href="#" class="arrow">
                    ...
                    <div class="entry-content">
                        ...
                        <div class="post-button text-right mt-5">
                            <span class="color-yellow fontSize13">
                                <a  href="<?php echo base_url(); ?>subscribe-exam-course?u=<?php echo encrypt_url($value['id']);?>&t='<?php echo encrypt_url('exams'); ?>"> Course Registration </a>  |
                                <a  href="<?php echo base_url(); ?>details?u=<?php echo encrypt_url($value['id']);?>&t='<?php echo encrypt_url('exams'); ?>"> View Detail </a>
                            </span>
                        </div>
                    </div>
                </div>
