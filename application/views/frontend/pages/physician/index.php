            ...
            <div class="col-md-12">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="<?php echo base_url(); ?>physician-sort?type=Upcoming">Upcoming Courses</a>                   
                    <a class="dropdown-item" href="<?php echo base_url(); ?>physician-sort?type=Completed">Completed Courses</a>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>physician-sort?type=Deferred">Deferred Courses</a>
                  </div>
                </div>
            </div>
        </div>
             ...
             ?>
                ...
                <div class="soapbox-inner-container white" role="link" tabindex="0">
                    ...
                    <div class="right-side-container">
                        <img src="<?php echo ASSET_UPLOADS_FRONTEND_DIR."physician/".$value['image'] ?>" alt="" aria-hidden="true">
                    </div>
                </div>
            </div>
           <?php } }  ?>
                ...
                <div class="col-12">
                    <div class="card mb-5">                     
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-center font-weight-bold">
                                We are currently working on Physicain Academic Courses.
                            </p>                            
                        </div>
                    </div>
                </div>
